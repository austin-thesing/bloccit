  ...
  context "guest" do
      describe "POST create" do
        ...
        it "redirects the user to the sign in view" do
          post :create, format: :js, post_id: my_post.id, comment: {title: RandomData.random_sentence, body: RandomData.random_paragraph} # shouldn't this be just body: ? Comments don't have titles do they?
