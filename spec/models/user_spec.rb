...
RSpec.describe User, type: :model do
  ...
  let(:user) {create(:user)} # => FactoryGirl supported User Factory/Creation

  it {is_expected.to have_many(:posts)}
  it {is_expected.to have_many(:comments)}
  it {is_expected.to have_many(:votes)}
  it {is_expected.to have_many(:favorites)}
  # is_expected.to tests for name
  it {is_expected.to validate_presence_of(:name) }
  it {is_expected.to validate_length_of(:name).is_at_least(1) }

  # is_expected.to tests for email
  ...
  # is_expected.to test for password
  ...
  describe "roles" do
    ...
    context "admin user" do
      before do
        user.admin! # what is this line doing?
      end
  ...
  describe "invalid user" do
    ...
    it "is an invalid user due to incorrectly formmated email address" do
  ...
  #   end
  #
  #   it "returns the appropriate favorite if it exsists" do
  ...
  describe ".avatar_url" do # => '.' used because this is a class method
